...
public class TileNetworkTestConcurrent extends TileEntity implements ITickable
{
    ...
    private void init()
    {
        ConcurrentGraph.integrate(networkHandler, getNeighbours(), (graph) -> new DebugGraphData());
    ...
    private List<GraphObject> getNeighbours()
    {
        ...
        for (EnumFacing f : EnumFacing.VALUES)
        {
            ...
            if (!(teOther instanceof TileNetworkTestConcurrent))
                continue;
            GraphObject thingOther = ((TileNetworkTestConcurrent) teOther).getNetworkHandler();
